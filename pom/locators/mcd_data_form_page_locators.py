class McdDataFormPageLocators:
    ...
    OPTION_2022 = ("XPATH", "//select[@id='codes-D176.V1']/option[@value='2022']")
    OPTION_2023 = ("XPATH", "//select[@id='codes-D176.V1']/option[@value='2023']")
    ALL_DATES_OPTION = ("XPATH", "//select[@id='codes-D176.V1']/option[@value='*All*']")
    CENSUS_REGION = ("XPATH", "//select[@id='SB_1']/optgroup/option[@value='D77.V10-level1']")
    ...
    ALL_DATES_OPTION_1999_2020 = ("XPATH", "//select[@id='codes-D77.V1']/option[@value='*All*']")
    MCD_ICD_10_CODES_1999_2020 = ("CSS", "input[id='RO_mcdD77.V13']")
    YEAR_OPTION_1999_2020 = ("XPATH", "//select[@id='SB_2']/optgroup/option[@value='D77.V1-level1']")
    MONTH_OPTION_1999_2020 = ("XPATH", "//select[@id='SB_3']/optgroup/option[@value='D77.V1-level2']")
