class McdDataFormPageLocators:
    FORM_TITLE = ("CSS", ".title > h1")
    GROUP_RESULT_BY_SELECTOR = ("ID", "SB_1")
    RESIDENCE_STATE_OPTION = ("CSS", "select[id='SB_1'] > optgroup > option[value='D176.V9-level1']")
    AND_BY_1 = ("ID", "SB_2")
    YEAR_OPTION = ("CSS", "select[id='SB_2'] > optgroup > option[value='D176.V1-level1']")
    AND_BY_2 = ("ID", "SB_3")
    MONTH_OPTION = ("CSS", "select[id='SB_3'] > optgroup > option[value='D176.V1-level2']")
    AND_BY_3 = ("ID", "SB_4")
    TEN_YEARS_OPTION = ("CSS", "select[id='SB_4'] > optgroup > option[value='D176.V5']")
    AND_BY_4 = ("ID", "SB_5")
    ...
    SEND_BUTTON = ("CSS", "div[class='footer-buttons'] > input[value='Send']")
    PROGRESS_BAR = ("ID", "progress-bar")
    OPTION_2021 = ("CSS", "select[id='codes-D176.V1'] > option[value='2021']")
